        	...
        	<div class="layoutDiv">
            	<div class="layoutDivA">
                	<div class="layoutDivC">
                        ...
                        <ul id="layoutDivUl">
                        	<li><a href="<?php echo U('Experience/design');?>" class="hover">>超易用设计</a></li>
                ...
                <div class="layoutDivB">
                	<div class="layoutDivD">
                    	<p class="layoutDivD-p"></p>
                        <div class="layoutDivE">
                        	<p><img src="__PUBLIC__/images/img2.jpg" /></p>
                            <p><img src="__PUBLIC__/images/img3.jpg" /></p>
                            <p><img src="__PUBLIC__/images/img4.jpg" /></p>
                            <p><img src="__PUBLIC__/images/img5.jpg" /></p>
                            <p><img src="__PUBLIC__/images/img6.jpg" /></p>
                            <p><img src="__PUBLIC__/images/img7.jpg" /></p>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
