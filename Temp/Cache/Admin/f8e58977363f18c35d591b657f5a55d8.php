...
<body topmargin="10" leftmargin="10">
    <!--中间内容左边内容-->
        	...
        	<td class="rightList02">
            	<div class="rightList">
                    ...
                    <ul>
                        ...
                        <?php echo getAuthCheck(MODULE_NAME.'-add',"<li><a href=".U('Voucher/add')." class='add'>添加</a></li>");?>
     ...
     <div id="search" style="display:none;">
      <form action="<?php echo U('Voucher/search');?>" method="get" enctype="multipart/form-data">
     	<table width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto; border:#c1e0f4 1px solid; margin-top:11px;">
        	<tr>
     ...
     <table id="table_form" width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" class="rightList03">
        ...
        <tr>
            ...
            <td width="10%" style="background-color:#eef1f3; border:none;">金额</td>
            <td width="10%" style="background-color:#eef1f3; border:none;">使用人</td>
            <td width="15%" style="background-color:#eef1f3; border:none;">备注</td>
            <td width="10%" style="background-color:#eef1f3; border:none;">到期时间</td>
            <td width="10%" style="background-color:#eef1f3; border:none;">添加时间</td>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td style="color:#7b7b8d;"><?php if(($vo["useusername"]) == ""): ?><span color='red'>未使用</span><?php else: echo ($vo["useusername"]); endif; ?></td>
            <td style="color:#7b7b8d;"><?php echo ($vo["remark"]); ?></td>
            <td style="color:#7b7b8d;"><?php echo (date("Y-m-d H:i:s",$vo["overtime"])); ?></td>
            <td style="color:#7b7b8d;"><?php echo (date("Y-m-d H:i:s",$vo["addtime"])); ?></td>
...
<script>
    ...
    function del(obj,id,name){
        if(confirm('您确定删除'+name+'？')){
            var url = "<?php echo U('Voucher/del');?>";
