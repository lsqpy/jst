...
<body topmargin="10" leftmargin="10">
    <!--中间内容左边内容-->
        	...
        	<td class="rightList02">
            	<div class="rightList">
                    ...
                    <ul>
                        ...
                        <?php echo getAuthCheck(MODULE_NAME.'-add',"<li><a href=".U('Articlecolumn/add')." class='add'>添加</a></li>");?>
     ...
     <div id="search" style="display:none;">
      <form action="<?php echo U('Articlecolumn/search');?>" method="get" enctype="multipart/form-data">
     	<table width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto; border:#c1e0f4 1px solid; margin-top:11px;">
        	<tr>
            	<td style="background-color:#edf2f5; border:#b9c8d6 1px solid; height:29px;" align="center">
                	<table cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                            ...
                            <td width="160">
                                <input type="text" id="keyword" style="width:150px;border:1px solid #D1D1D1" name="name">
                            </td>
                            <td>按名称搜索</td>
                        </tr>
     ...
     <table id="table_form" width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" class="rightList03">
        ...
        <tr>
            ...
            <td width="20%" style="background-color:#eef1f3; border:none;">显示名</td>
            <td width="12%" style="background-color:#eef1f3; border:none;">排序</td>
            <td width="12%" style="background-color:#eef1f3; border:none;">显示</td>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td style="color:#7b7b8d;text-align:left;text-indent:20px;"><a href="<?php echo U('Article/index',array('pid'=>$vo['id']));?>"><?php echo ($vo["html"]); echo ($vo["name"]); ?></a></td>
            <td style="color:#7b7b8d;"><?php echo ($vo["sort"]); ?></td>
            <td style="color:#7b7b8d;"><?php if(($vo["isshow"]) == "1"): ?>显示<?php else: ?>隐藏<?php endif; ?></td>
            <td style="color:#7b7b8d;"><?php if(($vo["status"]) == "1"): ?>审核<?php else: ?><font color=blue>屏蔽</font><?php endif; ?></td>
            
            <td align="center">
                <?php echo getAuthCheck(MODULE_NAME.'-edit',"<a href=".U('Articlecolumn/edit',array('id'=>$vo['id'])).">[编辑]</a>");?>
...
<script>
    ...
    function del(obj,id,name){
        if(confirm('您确定删除'+name+'？')){
            var url = "<?php echo U('Articlecolumn/del');?>";
