...
<body topmargin="10" leftmargin="10">
    <!--中间内容左边内容-->
        	...
        	<td class="rightList02">
            	<div class="rightList">
                    ...
                    <ul>
                        ...
                        <?php echo getAuthCheck(MODULE_NAME.'-add',"<li><a href=".U('Member/add')." class='add'>添加</a></li>");?>
     ...
     <div id="search" style="display:none;">
      <form action="<?php echo U('Member/search');?>" method="post" enctype="multipart/form-data">
     	<table width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto; border:#c1e0f4 1px solid; margin-top:11px;">
        	<tr>
     ...
     <table id="table_form" width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" class="rightList03">
        ...
        <tr>
            ...
            <td width="10%" style="background-color:#eef1f3; border:none;">用户名</td>
            <td width="12%" style="background-color:#eef1f3; border:none;">联系人</td>
            <td width="12%" style="background-color:#eef1f3; border:none;">联系电话</td>
            <td width="12%" style="background-color:#eef1f3; border:none;">Email</td>
            <td width="12%" style="background-color:#eef1f3; border:none;">最后登录时间</td>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td style="color:#7b7b8d;"><a href="<?php echo U('Member/edit',array('id'=>$vo['id']));?>"><?php echo ($vo["username"]); ?></a></td>
            <td style="color:#7b7b8d;"><?php echo ($vo["contact"]); ?></td>
            <td style="color:#7b7b8d;"><?php echo ($vo["phone"]); ?></td>
            <td style="color:#7b7b8d;"><?php echo ($vo["email"]); ?></td>
            <td style="color:#7b7b8d;"><?php echo (date("Y-m-d H:i:s",$vo["lasttime"])); ?></td>
            <td style="color:#7b7b8d;"><?php echo ($vo["status"]); ?></td>
            <td align="center">
                <?php echo getAuthCheck(MODULE_NAME.'-edit',"<a href=".U('Member/edit',array('id'=>$vo['id'])).">[编辑]</a>");?>
                <?php echo getAuthCheck(MODULE_NAME.'-del',"<a href='javascript:void(0);' onclick='del(this,$vo[id],\"".$vo['username']."\")'>[删除]</a> ");?>
                <div class="clear"></div>
