...
<body topmargin="10" leftmargin="10">
    <!--中间内容左边内容-->
        	...
        	<td class="rightList02">
            	<div class="rightList">
                	<ul>
                        ...
                        <?php echo getAuthCheck(MODULE_NAME.'-add',"<li><a href=".U('UploadImage/add')." class='add'>添加</a></li>");?>
     ...
     <div id="search" style="display:none;">
      <form action="<?php echo U('UploadImage/search');?>" method="get" enctype="multipart/form-data">
     	<table width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto; border:#c1e0f4 1px solid; margin-top:11px;">
        	<tr>
            	<td style="background-color:#edf2f5; border:#b9c8d6 1px solid; height:29px;" align="center">
                	<table cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                            <td width="90" align="center" height="25">标题：</td>
                            <td width="160">
     ...
     <table id="table_form" width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" class="rightList03">
        ...
        <tr>
            ...
            <td width="20%" style="background-color:#eef1f3; border:none;">标题</td>
            <td width="5%" style="background-color:#eef1f3; border:none;">类型</td>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td style="color:#7b7b8d;">
            <?php echo ($vo["title"]); ?>
            <?php if(isset($vo["litpic"])): ?><font color="blue">[图]</font><?php endif; ?>
            </td>
            <td style="color:#7b7b8d;"><?php echo ($vo["type"]); ?></td>
            ...
            <td align="center">
                <?php echo getAuthCheck(MODULE_NAME.'-edit',"<a href=".U('UploadImage/edit',array('id'=>$vo['id'])).">[编辑]</a>");?>
...
<script>
    ...
    function sort(name,value){
        var url = "<?php echo U('UploadImage/sort');?>";
    ...
    function del(obj,id,name){
        if(confirm('您确定删除'+name+'？')){
            var url = "<?php echo U('UploadImage/del');?>";
