...
<body topmargin="10" leftmargin="10">
    <!--中间内容左边内容-->
     ...
     <form action="<?php echo U('Article/doEdit');?>" method="post" enctype="multipart/form-data">
     ...
     <table width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" class="rightCon">
        ...
        <tr>
            ...
            <td width="85%">
                &nbsp;推荐<input type="checkbox" <?php if(in_array(1,$info['attr'])): ?>checked="checked"<?php endif; ?> value="1" name="aid[]"/>
                &nbsp;精华<input type="checkbox" <?php if(in_array(2,$info['attr'])): ?>checked="checked"<?php endif; ?> value="2" name="aid[]"/>
                &nbsp;置顶<input type="checkbox" <?php if(in_array(3,$info['attr'])): ?>checked="checked"<?php endif; ?> value="3" name="aid[]"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="85%">
                ...
                <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if(($info["cid"]) == $vo["id"]): ?>selected = selected<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["level"]); ?>、<?php echo ($vo["html"]); echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td width="85%">
                <input name="litpic" type="file" class="rightCon02"/>
                <input name="litpic_name" type="hidden" value="<?php echo ($info["litpic"]); ?>" />
            </td>
        </tr>
        <tr>
