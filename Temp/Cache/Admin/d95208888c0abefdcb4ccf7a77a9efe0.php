...
<body topmargin="10" leftmargin="10">
    <!--中间内容左边内容-->
        	...
        	<td class="rightList02">
            	<div class="rightList">
                    ...
                    <ul>
                        ...
                        <?php echo getAuthCheck(MODULE_NAME.'-add',"<li><a href=".U('Sensitive/add')." class='add'>添加</a></li>");?>
     ...
     <div id="search" style="display:none;">
      <form action="<?php echo U('Sensitive/search');?>" method="post" enctype="multipart/form-data">
     	<table width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto; border:#c1e0f4 1px solid; margin-top:11px;">
        	<tr>
     ...
     <table id="table_form" width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" class="rightList03">
        ...
        <tr>
            ...
            <td width="20%" style="background-color:#eef1f3; border:none;">敏感词</td>
            <td width="20%" style="background-color:#eef1f3; border:none;">替换词</td>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td style="color:#7b7b8d;"><a href="<?php echo U('Sensitive/edit',array('id'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a></td>
            <td style="color:#7b7b8d;"><?php echo ($vo["sensitive"]); ?></td>
            <td style="color:#7b7b8d;"><?php if(($vo["status"]) == "1"): ?>审核<?php else: ?><font color=blue>屏蔽</font><?php endif; ?></td>
            
            <td align="center">
               
                <?php echo getAuthCheck(MODULE_NAME.'-edit',"<a href=".U('Sensitive/edit',array('id'=>$vo['id'])).">[编辑]</a>");?>
...
<script>
    ...
    function del(obj,id,name){
        if(confirm('您确定删除'+name+'？')){
            var url = "<?php echo U('Sensitive/del');?>";
