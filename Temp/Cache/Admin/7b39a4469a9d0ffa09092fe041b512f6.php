...
<body topmargin="10" leftmargin="10">
    <!--中间内容左边内容-->
     <table width="98%" height="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto;">
     	<tr>
        	<td>
            	<div class="right"><p style="background:url(../Public/images/weizhi.jpg) no-repeat 0px 14px;"> 当前位置：新增&nbsp;>&nbsp;</p></div>
            </td>
        </tr>
     </table>
     
     <form action="<?php echo U('Shop/doAdd');?>" method="post" enctype="multipart/form-data">
