    ...
    <!--中间内容左边内容-->
        	...
        	<td class="rightList02">
            	<div class="rightList">
                    ...
                    <ul>
                        ...
                        <?php echo getAuthCheck(MODULE_NAME.'-add',"<li><a href=".U('Admin/add')." class='add'>添加</a></li>");?>
     ...
     <table id="table_form" width="98%" height="100%" cellpadding="0" cellspacing="0" align="center" class="rightList03">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center">
                <?php echo getAuthCheck(MODULE_NAME.'-edit',"<a href=".U('Admin/edit',array('id'=>$vo['id'])).">[编辑]</a>");?>
